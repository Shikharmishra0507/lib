...
public class register extends JFrame {
	...
	public register() {
		...
		ImageIcon imageIcon1 = new ImageIcon(new ImageIcon("./res/back.png").getImage().getScaledInstance(70, 70, Image.SCALE_SMOOTH));
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					conn connectionObj=conn.getInstance();
					...
					connectionObj.registerUser(std_name,std_pass);
...
//					int std_id=rs.getInt(1);
					JOptionPane.showMessageDialog(null, "User is succesfully registered");
					}
		...
		ImageIcon imageIcon = new ImageIcon(new ImageIcon("./res/register.jpg").getImage().getScaledInstance(1000, 1000, Image.SCALE_SMOOTH));
