	...
	public addbook() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				connectionObj.addnewBook(bname,author);
...
//				int book_id=rs.getInt(1);
       ...
       JLabel lblNewLabel = new JLabel("New label");
		...
		ImageIcon imageIcon1 = new ImageIcon(new ImageIcon("./res/book.jpg").getImage().getScaledInstance(1000, 1000, Image.SCALE_SMOOTH));
