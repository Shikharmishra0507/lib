...
public class login extends JFrame {
	...
	public login() {
		...
		JLabel lblNewLabel_1 = new JLabel("Welcome to LCIT Library ");
			...
			public void actionPerformed(ActionEvent e) {
				...
				else
				{
					  try {
						  ...
						  connectionObj.loginUser(textuser.getText(),textpass.getText());
//		                   conn c=new conn();
//
...
//		        			}
						  setVisible(false);
						  new user(textuser.getText()).setVisible(true);
					  }
		...
		ImageIcon imageIcon = new ImageIcon(new ImageIcon("./res/login.jpg").getImage().getScaledInstance(1000, 1000, Image.SCALE_SMOOTH));
