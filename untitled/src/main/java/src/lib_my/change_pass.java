...
public class change_pass extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					change_pass frame = new change_pass(name);
	...
	public change_pass(String name) {
		...
		ImageIcon imageIcon = new ImageIcon(new ImageIcon("./res/back.png").getImage().getScaledInstance(70, 70, Image.SCALE_SMOOTH));
		...
		ImageIcon imageIcon1 = new ImageIcon(new ImageIcon("./res/background.jpg").getImage().getScaledInstance(1000, 1000, Image.SCALE_SMOOTH));
