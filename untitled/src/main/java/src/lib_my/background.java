...
public class background extends JFrame {
	...
	public background() {
		...
		ImageIcon imageIcon = new ImageIcon(new ImageIcon(background.class.getResource("/lib_my/background.jpg")).getImage().getScaledInstance(1000, 1000, Image.SCALE_SMOOTH));
